        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('categories.create')}}" class="btn btn-success" role="button" aria-disabled="true">Add Category</a>
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete_category{{$category->id}}">Delete</button>
                                </td>
