        ...
        <!-- Main content -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{route('productsOut.create')}}" class="btn btn-success" role="button" aria-disabled="true">Add Products Out</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($invoice_data as $i)
                            <tr>
                                ...
                                <td>{{$i->date}}</td>
                                <td>
                                    <a href="{{route('productsOut.edit',$i->id)}}" class="btn btn-primary btn-sm" role="button" aria-disabled="true">Edit</a>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($invoice_data as $i)
                            <tr>
                                ...
                                <td>{{$i->date}}</td>
                                <td>
                                    <a href="{{route('exportPDF.productOut',$i->id)}}" class="btn btn-primary btn-sm" role="button" aria-disabled="true">Export Invoice</a>
                                </td>
